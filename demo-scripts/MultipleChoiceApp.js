...
var MultipleChoiceApp = MultipleChoiceApp || {};

MultipleChoiceApp.init = function() {
    MultipleChoiceApp.load_question();
};

MultipleChoiceApp.refresh = function() {
    /* METHOD: Refreshes div ids that the questions and choices are written to. */
    $('#question').html('');
    $('#options').html('');
};

MultipleChoiceApp.load_question = function() {
...
MultipleChoiceApp.advance_question = function(id_value) {
