...
* The main script can handle any number of options that are separated by commas. The above could be amended, for example, to contain an extra option "Sir Lancelot" by inserting it like so "ni,Sir Robin,Sir Galahad,Sir Lancelot". NB: Do not add the answer to the list of options, or the quiz will print it out twice.
